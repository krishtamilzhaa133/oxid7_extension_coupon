...
$aModule = [
        ...
        'thumbnail'   => 'img/avaliablecoupons.png',
        'version'     => '2.1.0',
        'author'      => 'Novalnet Developer',
        'url'         => 'https://www.novalnet.com',
        'email'       => 'technical@novalnet.de',
        'extend'      => [
            \OxidEsales\Eshop\Application\Controller\FrontendController::class => Nncoupons\Controller\AvaliableCouponsController::class,
            
        ],
        'controllers'  => [  
                'account_avaliablecoupons'         => Nncoupons\Controller\AvaliableCouponsController::class,
